    ...
    return (
      <Container fluid className="main-content-container px-4">
        ...
        <Col lg="4" md="4" sm="12" className="mb-4">
          <PageTitle sm="12" title="Blog Posts" subtitle="Components" className="text-sm-left" />
        </Col>
        <Col lg="6" md="6" sm="12" className="mb-4">
        </Col>
        <Col lg="2" md="2" sm="12" className="mb-4">
        ...
        {/* First Row of Posts */}
        <Row>
          {library_resources.map((post, idx) => (
            <Col lg="3" md="6" sm="12" className="mb-4" key={idx}>
              <Card small className="card-post card-post--1">
                ...
                >
                <VideoThumbnail video_url = "https://www.youtube.com/watch?v=7ZCZLj2IY7s"/> 
                                <div className={`card-post__category`}>
                <Confirmation deleteHandler = {this.deleteHandler} id = {post.id}/>
                {/* <Button theme="light" style = {{marginRight : '8px'}}>
                <MdDelete onClick = { () => this.deleteHandler(post.id)}/>
                </Button> */}
                <Button theme="light">
                <MdEdit />  
                </Button> 
